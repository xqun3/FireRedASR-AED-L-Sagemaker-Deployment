...
def main():
    ...
    parser.add_argument("--local_dir_path", type=str, default="model_repository", required=True, help="Local directory path to save the downloaded files")
    parser.add_argument("--working_dir", type=str, default="/opt/ml/model", help="Working directory (default: /workspace)")
